...
CREATE TABLE `usersDashboards` (
	...
	CONSTRAINT `idx_users_dashboards_unique` UNIQUE(`idUsers`,`dashboardsId`)
);
--> statement-breakpoint
CREATE TABLE `users` (
	`id` int AUTO_INCREMENT NOT NULL,
...
CREATE INDEX `aiInstanceIdx` ON `accountsInstances` (`instancesId`);--> statement-breakpoint
